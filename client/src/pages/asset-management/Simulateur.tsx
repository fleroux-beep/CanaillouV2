                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-right">
                              <span className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${
                                ...
                                s.dscr >= 1.2 ? "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400" :
                    ...
                    <tbody>
                      {stressResults.map((s, i) => {
                        ...
                        const ratingColor = score >= 8 ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" :
                          score >= 6 ? "bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400" :
