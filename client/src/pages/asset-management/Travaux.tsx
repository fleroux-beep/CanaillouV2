...
export default function TravauxPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => { e.preventDefault(); if (editing) { await update({ ...form, id: editing.id } as Travaux); } else { await create(form); } setDialogOpen(false); };
